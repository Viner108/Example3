...
//        int[] object3 = new int[3];// третий объект для размещенние в массив с нулевыми значениями
//        ob.objectCreate( object); // функция для размещение первого объкта в массиве
//        obobjectCreate( object2);// функция для размещение второго объкта в массиве
//        objectCreate( object3);// функция для размещение третьего объкта в массиве
//        int indexofobject1 = 0;
//        int indexofobject2 = 2;
...
//        object3[0] = 302;
//        object3[2] = 27;
//        objectCreate( object); // функция для размещение первого объкта в массиве
//        objectCreate( object2);// функция для размещение второго объкта в массиве
//        objectCreate( object3);// функция для размещение третьего объкта в массиве
//        int indexofobject1 = 2;
//        int indexofobject2 = 0;
//        int[] array2 = swap2( indexofobject1, indexofobject2);
////      ob.printLines(array2);
//        if (!(array2[0] == 6 &&
//                array2[1] == 0 &&
//                array2[2] == 0 &&
...
//        objectCreate( object1); // функция для размещение первого объкта в массиве
//        objectCreate( object2);// функция для размещение второго объкта в массиве
//        objectCreate( object3);// функция для размещение второго объкта в массиве
//        objectCreate(object4);// функция для размещение третьего объкта в массиве
//        objectCreate( object5);// функция для размещение третьего объкта в массиве
//        objectCreate( object6);// функция для размещение третьего объкта в массиве
//        int[] array2 = sorting();
//      ob.printLines(array2);
//        if (!(array2[0] == 2 &&
//                array2[1] == 0 &&
